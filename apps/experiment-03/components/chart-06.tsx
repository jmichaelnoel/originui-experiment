    ...
    <Card className="gap-5">
      ...
      <CardContent className="flex flex-col gap-5">
        <div className="flex gap-1 h-5">
          ...
          <div className="bg-linear-to-r from-chart-2 to-chart-1 h-full" style={{ width: "24%" }}></div>
          <div className="bg-chart-6 h-full" style={{ width: "16%" }}></div>
          <div className="bg-chart-3 h-full" style={{ width: "38%" }}></div>
        </div>
        <div>
          <div className="text-[13px]/3 text-muted-foreground/50 mb-3">Reason for upgrading</div>
          <ul className="text-sm divide-y divide-border">
            ...
            <li className="py-2 flex items-center gap-2">
              <span className="size-2 shrink-0 rounded-full bg-linear-to-r from-chart-2 to-chart-1" aria-hidden="true"></span>
              <span className="grow text-muted-foreground">Enhanced assistance and protection.</span>
