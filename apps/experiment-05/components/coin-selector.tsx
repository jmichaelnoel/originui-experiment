...
const coins = [
  { value: "TRX", name: "Tronix", icon: "https://res.cloudinary.com/dlzlfasou/image/upload/v1742390289/coin-01_tidmpi.svg" },
  { value: "TOK", name: "Turbo Koin", icon: "https://res.cloudinary.com/dlzlfasou/image/upload/v1742390289/coin-02_a6ineb.svg" },
  { value: "SAP", name: "Swap", icon: "https://res.cloudinary.com/dlzlfasou/image/upload/v1742391614/coin-03_w8kee9.svg" },
  { value: "SUV", name: "SuvFi", icon: "https://res.cloudinary.com/dlzlfasou/image/upload/v1742391613/coin-04_hfq2hc.svg" },
];
            ...
            {value ? (
              <span className="flex min-w-0 items-center gap-2">
                {(() => {
                  ...
                  return (
                    <>
                      <img src={selectedCoin?.icon} alt={selectedCoin?.name} className="size-5" />
