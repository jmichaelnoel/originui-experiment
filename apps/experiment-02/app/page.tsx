...
export default function Page() {
  return (
    <SidebarProvider>
      <AppSidebar />
      <SidebarInset className="overflow-hidden bg-sidebar group/sidebar-inset">
        ...
        <div className="flex flex-1 flex-col gap-4 lg:gap-6 py-4 lg:py-6 px-4 md:px-6 lg:px-8 bg-background md:rounded-s-3xl shadow-md md:peer-data-[state=collapsed]:group-[]/sidebar-inset:rounded-s-none transition-all">
          {/* Page intro */}
